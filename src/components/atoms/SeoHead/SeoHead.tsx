...
const SeoHead: FC<HeadProps> = ({
	...
	return (
		<Head>
			...
			<meta name="og:url" content="https://sesn.in/" />
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: `{"@context":"http://schema.org","@type":"WebSite","name":"sesn.in","alternateName":"SESN","url":"https://sesn.in/","description":"As a passionate Software Engineer, I produce elegant, performant, and accessible digital experiences with more than 6 years of experience","image":"${image}"}`,
				}}
			/>
			{/* <script
				type="application/ld+json"
